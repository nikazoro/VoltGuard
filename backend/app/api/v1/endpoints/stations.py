...
from ....models.models import Station, User
...
async def create_station(
    ...
    current_user: User = Depends(require_role(UserRole.station_owner)),
):
    station = Station(
    ...
    station.location = from_shape(
        Point(payload.location_lat, payload.location_lng),
        srid=4326
    )
