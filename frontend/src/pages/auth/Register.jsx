                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <label className="relative flex cursor-pointer">
                                    <input
                                        ...
                                        {...register('role')}
                                    />
                                    <div className="w-full rounded-lg border-2 border-muted bg-background p-4 text-center peer-checked:border-slate-900 peer-checked:bg-slate-50 hover:bg-accent transition-colors">
