            ...
            <section className="bg-gradient-to-br from-green-50 to-blue-50 py-20 px-4">
                <div className="container mx-auto text-center max-w-4xl">
                    <div className="flex justify-center mb-6">
                        <div className="h-20 w-20 rounded-full bg-slate-900 dark:bg-slate-100 flex items-center justify-center">
                            <Zap className="h-10 w-10 text-white dark:text-slate-900" />
                        </div>
                    </div>
                    <h1 className="text-5xl md:text-6xl font-bold mb-6">
                        Welcome to <span className="text-slate-900 dark:text-slate-100">EcoCharge</span>
                    </h1>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <Card>
                            <CardContent className="pt-6">
                                <div className="h-12 w-12 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
                                    <MapPin className="h-6 w-6 text-slate-900 dark:text-slate-100" />
                                </div>
                        ...
                        <Card>
                            <CardContent className="pt-6">
                                <div className="h-12 w-12 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
                                    <TrendingUp className="h-6 w-6 text-slate-900 dark:text-slate-100" />
                                </div>
